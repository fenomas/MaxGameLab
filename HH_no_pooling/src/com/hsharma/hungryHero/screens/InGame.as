...
package com.hsharma.hungryHero.screens
{
	...
	public class InGame extends Sprite
	{
		...
		{
			itemsPool = new PoolItem(foodItemCreate, foodItemClean, 0);
		}
		...
		private function foodItemCreate():Item
		{
			...
			Telemetry.sendMetric("createdFood",1);
			return foodItem;
		}
		...
		{
			obstaclesPool = new PoolObstacle(obstacleCreate, obstacleClean, 0, 10);
		}
		...
		{
			eatParticlesPool = new PoolParticle(eatParticleCreate, eatParticleClean, 0, 30);
		}
		...
		{
			windParticlesPool = new PoolParticle(windParticleCreate, windParticleClean, 0, 30);
		}
		...
		{
			Telemetry.sendMetric("This is HH_v1", 1);
			trace("ditto");
