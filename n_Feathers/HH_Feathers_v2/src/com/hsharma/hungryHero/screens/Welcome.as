...
package com.hsharma.hungryHero.screens
{
	...
	public class Welcome extends Sprite
	{
		...
		private function drawScreen():void
		{
			...
			// Step 1: Add Scores
			scoresBtn = new Button(Assets.getAtlas().getTexture("obstacle3"));
			scoresBtn.x = 620;
			scoresBtn.y = 510;
			scoresBtn.addEventListener(Event.TRIGGERED, onScoresClick);
		...
		// Step 3:
		private function onScoresClick(event:Event):void
		{
			if (!Sounds.muted) Sounds.sndMushroom.play();
		...
		private function floatingAnimation(event:Event):void
		{
			...
			scoresBtn.y = 510 + (Math.cos(_currentDate.getTime() * 0.002)) * 10;
		}
