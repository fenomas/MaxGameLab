...
package com.hsharma.hungryHero.screens
{
	...
	public class InGame extends Sprite
	{
		...
		/*	Collection of item container sprites. Static for convenience in this demo. */
		private static var itemLayers:Vector.<Sprite>;
		...
		{
			// create item layer sprites
			itemLayers = new Vector.<Sprite>;
			for (var i:int=1; i<=7; i++) {
				var layer:Sprite = new Sprite();
				itemLayers[i-1] = layer;
				addChild(layer);
			}
		...
		/*	Public static accessor for item layers, for convenience in this demo */
		public static function getItemLayer( num:int ):Sprite {
			if (num<1 || num>7) { return null; }
			return itemLayers[num-1];
		}
