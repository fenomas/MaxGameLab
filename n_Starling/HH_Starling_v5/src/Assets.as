...
package 
{
	...
	public class Assets
	{
		 ...
		 * Texture Atlas 
		 */
		[Embed(source="graphics/mySpritesheet_DXTc.atf", mimeType="application/octet-stream")]
		 ...
		 * Background Assets 
		 */
		[Embed(source="graphics/bgLayer1_DXTc.atf", mimeType="application/octet-stream")]
		public static const BgLayer1:Class;
		
		[Embed(source="graphics/bgWelcome_DXTc.atf", mimeType="application/octet-stream")]
		...
		public static function getAtlas():TextureAtlas
		{
			...
			{
				var data:ByteArray = new AtlasTextureGame();
		...
		public static function getTexture(name:String):Texture
		{
			...
			{
				var data:ByteArray = new Assets[name]();
				gameTextures[name]=Texture.fromAtfData(data); //Texture.fromBitmap(bitmap);
			}
