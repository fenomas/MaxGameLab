...
package com.hsharma.hungryHero.screens
{
	...
	import starling.extensions.TransparentButton;
	...
	public class Welcome extends Sprite
	{
		...
		/** Hero artwork. */
		private var hero:TransparentButton;
		...
		private function drawScreen():void
		{
			...
			hero = new TransparentButton(Assets.getFrameBitmap("welcome_hero"));
			hero.x = -hero.width;
			hero.y = 130;
			hero.addEventListener(Event.TRIGGERED, onPlayClick);
			this.addChild(hero);
