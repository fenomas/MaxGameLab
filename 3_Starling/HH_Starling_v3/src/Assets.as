...
package 
{
	...
	public class Assets
	{
		...
		/* 		helper function to get a particular frame bitmap out of the atlas */
		public static function getFrameBitmap(name:String):BitmapData
		{
			var textureBMD:BitmapData = new AtlasTextureGame().bitmapData;
			var region:Rectangle = getAtlas().getRegion(name);
			var bmd:BitmapData = new BitmapData(region.width, region.height, true, 0);
			bmd.copyPixels(textureBMD, region, new Point);
			return bmd;
		}
